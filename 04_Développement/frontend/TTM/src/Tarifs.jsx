...
function buildWhatsAppUrl(service) {
  // wa.me attend un numéro en format international sans + ni 00
  let phone = WHATSAPP_NUMBER.replace(/\D/g, "");
  if (phone.startsWith("00")) phone = phone.slice(2);

  const text = `Bonjour 👋, je souhaite *demander le service* "${service.title}"

💰 Tarif indiqué : ${service.amount}
👤 Nom : [Votre nom]
