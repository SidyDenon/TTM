...
import vitrineServicesRoutes from "./routes/admin/vitrine.services.js";
import configRoutes from "./routes/admin/config.js";
import servicesPublicRoutes from "./routes/public/services.public.js";
import vitrineServicesPublicRoutes from "./routes/public/vitrine.services.public.js";
import contactPublicRoutes from "./routes/public/contact.public.js";
...
app.use("/api/admin/vitrine/services", vitrineServicesRoutes(db));
...
app.use("/api/contact/public", contactPublicRoutes(db));
